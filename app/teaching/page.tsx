...
const services = [
  ...
  },
  {
    ...
    description:
      "A comprehensive preparation package designed for students pursuing BFA and MFA programs. Kyle will help you build a competitive, well-rounded audition that showcases range and readiness.",
    items: [
